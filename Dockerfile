...
RUN CGO_ENABLED=0 GOOS=linux GOARCH=amd64 \
    ...
    go build -trimpath -ldflags='-s -w' -o /out/audit-kafka-dlq-replay ./cmd/audit-kafka-dlq-replay && \
...
COPY --from=build /out/audit-kafka-dlq-replay /audit-kafka-dlq-replay
